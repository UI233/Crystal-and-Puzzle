...
QT_MOC_LITERAL(4, 26, 5) // "moved"

    },
    "Display\0clicked\0\0released\0moved"
};
...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->moved((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Display::*_t)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Display::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Display::released)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Display::*_t)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Display::moved)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject Display::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Display.data,
...
// SIGNAL 0
void Display::clicked(int _t1, int _t2)
{
...
// SIGNAL 1
void Display::released()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Display::moved(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
